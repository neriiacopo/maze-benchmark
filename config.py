...
def last_wish_msg(cause): 
    ...
    return f"GAME OVER: {causes_death.get(cause, 'Unknown reason')}. Now, review your journey through your notes. You have the chance to leave a final message to your future self, who will attempt the maze again. STRICT RULE: Do not use conversational filler, bullet points, or headers inside JSON values."
